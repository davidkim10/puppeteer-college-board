export const STEP2 = {
  ...
  question5: {
    label: "Are you an orphan or ward of the court?",
    input: {
      type: "radio",
      id: null,
      options: [
  ...
  question6: {
    label: "Are you an emancipated minor?",
    input: {
      type: "radio",
      id: null,
      options: [
  ...
  question7: {
    label: "Are you homeless or at risk of being homeless?",
    input: {
      type: "radio",
      id: null,
      options: [
